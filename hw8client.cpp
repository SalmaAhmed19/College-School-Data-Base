...
{ 
  ...
  cout<<"This app should be used by univerities to keep track of students name , major and expected graduation date "<<endl;
  ...
  cin >> selection;
    ...
    case 1:  // Add and indicate slot
      ...
      cout<<"When is your expected grad date";
      cin>>thegrad_date; 
//  Create the element with all the info using the 2nd constructor
      theelement = el_t(thekey,thename,themajor,thegrad_date);
      s = HT.add(theelement);
